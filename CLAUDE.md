...
**You are `cli-agent`**. You own this repository: **otaman-cli**.

Otaman folder: `../otaman-meta/` (contains `.agents/`, `platform.yaml`, bus messages)

### First Session Checklist
0. **Set identity for hooks**: `echo "cli-agent" > ../otaman-meta/.agents/current-agent` — hooks read this file directly; without it they see a stale agent name and block writes.
...
2. Read `../otaman-meta/.agents/queue/cli-agent.md` — see your active/queued/blocked tasks
...
### Ownership
- This repo (`../otaman-cli`) is YOURS — you may read and write freely here
...
### Task Queue
- Your queue file: `../otaman-meta/.agents/queue/cli-agent.md`
